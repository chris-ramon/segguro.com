...
import (
	...
	"github.com/chris-ramon/golang-scaffolding/domain/visitors"
...
func main() {
	...
	*/
	...
	visitorService, err := visitors.NewService()
	if err != nil {
		handleErr(err)
	}

	gqlHandlers, err := gql.NewHandlers(authService, usersService, visitorService)
	if err != nil {
		handleErr(err)
	}
